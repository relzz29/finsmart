...
export default function Education() {
  ...
  // Flag: true kalau data yang ditampilkan adalah mock (bukan dari server)
  ...
  useEffect(() => {
    educationApi.getArticles()
      .then(d => {
        ...
        setIsMock(false) // data berhasil dari server, tidak perlu warning
      })
      .catch(() => {
        // Fallback ke mock, tapi tandai agar user tahu
  ...
  return (
    <div className="app-shell">
      <div className="page">
        ...
        {/* Banner peringatan — hanya muncul kalau data dari mock (server gagal) */}
        {isMock && !loading && (
          <div style={{
            ...
            <span>⚠️</span>
            <span>Gagal memuat artikel dari server. Menampilkan data contoh — mungkin tidak terkini.</span>
          </div>
        )}
